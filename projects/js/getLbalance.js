...
var HowManyRepeatUnrecognize = 0;
	...
	//+++++++++++++++++++Setings
	var LIST_file="AllL";// where get adreses
	var total_file="totalL.csv"; // where put recived data
	var log_file = "logL.log"; // 
	//-------------------Setings
...
function GetBalanceFromBCI(){
	...
	var get_data="http://explorer.litecoin.net/chain/Litecoin/q/addressbalance/"+adr;// <-------------- API 
